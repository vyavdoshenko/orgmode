...
alias docker_builder_build="docker build --build-arg UID=\$(id -u) -t builder ."
alias docker_builder_start="docker stop builder-container && docker rm builder-container && docker run --user builder --mount type=bind,source=\${HOME}/veego,destination=/home/builder/veego -it --name builder-container builder /usr/bin/zsh"
