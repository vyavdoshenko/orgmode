...
alias builder_start="docker stop builder-container && docker rm builder-container && docker run --user builder --mount type=bind,source=\${HOME}/dragonfly,destination=/home/builder/dargonfly -it --name builder-container builder /usr/bin/zsh"
alias builder_first_start="docker run --user builder --mount type=bind,source=\${HOME}/dragonfly,destination=/home/builder/dragonfly -it --name builder-container builder /usr/bin/zsh"
